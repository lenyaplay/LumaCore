...
/// ffigen bindings for native/src/api/lumacore_api.h. Only the high-frequency dart:ffi surface is generated (ARCHITECTURE.md §3) — session lifecycle, per-frame rendering, and recording control are Obj-C++/Swift-only and never called from Dart, see ai_plans/03-ios-metal-render-pipeline.md §9.
///
class LumaCoreBindingsGenerated {
  /// Holds the symbol lookup function.
  final ffi.Pointer<T> Function<T extends ffi.NativeType>(String symbolName)
  _lookup;

  /// The symbols are looked up in [dynamicLibrary].
  LumaCoreBindingsGenerated(ffi.DynamicLibrary dynamicLibrary)
    : _lookup = dynamicLibrary.lookup;

  /// The symbols are looked up with [lookup].
  LumaCoreBindingsGenerated.fromLookup(
    ffi.Pointer<T> Function<T extends ffi.NativeType>(String symbolName) lookup,
  ) : _lookup = lookup;

  void lumacore_set_effect_params(
    int session,
    ffi.Pointer<LumaEffectParams> params,
  ) {
    return _lumacore_set_effect_params(session, params);
  }

  late final _lumacore_set_effect_paramsPtr = _lookup<
    ffi.NativeFunction<
      ffi.Void Function(ffi.Int64, ffi.Pointer<LumaEffectParams>)
    >
  >('lumacore_set_effect_params');
  late final _lumacore_set_effect_params =
      _lumacore_set_effect_paramsPtr
          .asFunction<void Function(int, ffi.Pointer<LumaEffectParams>)>();

  void lumacore_get_stats(int session, ffi.Pointer<LumaStats> outStats) {
    return _lumacore_get_stats(session, outStats);
  }

  late final _lumacore_get_statsPtr = _lookup<
    ffi.NativeFunction<ffi.Void Function(ffi.Int64, ffi.Pointer<LumaStats>)>
  >('lumacore_get_stats');
  late final _lumacore_get_stats =
      _lumacore_get_statsPtr
          .asFunction<void Function(int, ffi.Pointer<LumaStats>)>();
}
...
final class LumaEffectParams extends ffi.Struct {
  @ffi.Float()
  ...
  @ffi.Float()
  external double vignetteRadius;

  @ffi.Float()
  external double vignetteSoftness;

  @ffi.Float()
  external double particleIntensity;
...
final class LumaStats extends ffi.Struct {
  ...
  @ffi.Double()
  external double avgFrameMs;

  @ffi.Uint32()
  external int droppedFrames;

  @ffi.Int32()
  external int thermalState;
}
